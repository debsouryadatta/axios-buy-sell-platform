...
const MainPage = () => {
    return (
        <div className='bg-blue-gray-400'>
            ...
            <Parallax pages={2} style={{ top: '0', left: '0' }} className='bg-blue-gray-800'>
                ...
                <ParallaxLayer offset={0.98} speed={1.5} style={{
                ...
                <ParallaxLayer offset={1} speed={1.5} factor={0.2} className='z-10' >
                    <Footer />
                </ParallaxLayer>
            </Parallax>
        </div >
