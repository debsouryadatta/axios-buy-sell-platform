...
const Rent = () => {
  ...
  return (
    <>
      <div>
        <h2 className="text-xl sm:text-4xl text-center mt-4 text-white font-bold">Rental Product List</h2>
        {/* Searchbar & Categories */}
        <div className="flex flex-col items-center">
          <form className="w-[80%]">
            <div className="flex my-10">
              <select className="w-[80px] sm:w-[15%] outline-none border-gray-300 rounded-lg text-center cursor-pointer out"
                name="cars"
                id="cars"
                onChange={(e) => {
